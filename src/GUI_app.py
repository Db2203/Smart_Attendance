...
class SmartAttendanceApp:
    def __init__(self, master):
        ...
        try:
            self.master.iconphoto(True, tk.PhotoImage(file='assets/logo.png'))
        except:
        ...
        try:
            self.button_image = tk.PhotoImage(file='assets/click.png')
            self.download_image = tk.PhotoImage(file='assets/download.png')
        except:
    ...
    def load_student_encodings(self):
        ...
        if os.path.exists("data/student_encodings.pkl"):
    ...
    def precompute_student_encodings(self, df):
        ...
        with open("data/student_encodings.pkl", "wb") as f:
